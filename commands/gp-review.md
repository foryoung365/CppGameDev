...
5. Run the `gp-experience-researcher` agent against the current review scope, and collect relevant prior learnings from the host project as secondary context only.
